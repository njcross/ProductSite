...
export default function CartPage() {
  ...
  <div className="cart-col" style={{ flex: '20%' }}></div> {/* Image */}
  <div className="cart-col" style={{ flex: '30%' }}><EditableField contentKey="content_238" /></div>
  <div className="cart-col" style={{ flex: '20%' }}><EditableField contentKey="content_239" /></div>
  <div className="cart-col" style={{ flex: '20%' }}><EditableField contentKey="content_240" /></div>
  <div className="cart-col" style={{ flex: '10%' }}></div> {/* Trash */}
</div>
  ...
  return (
    <div className="cart-item d-flex" key={item.id} onClick={() => navigate(`/edit/${details.kit_id}`)}>
      ...
      <div className="cart-col" style={{ flex: '30%' }}>
        <h5>{details.name}</h5>
      </div>
